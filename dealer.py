...
def createGUI():
    ...
    text1 = canvas1.create_text(520,250,text=dealTotal, font=('Helvetica','20','bold'))
    text2 = canvas1.create_text(520,200,text=dealCards, font=('Helvetica','20','bold'))
    text3 = canvas1.create_text(520,100,text=currTotal, font=('Helvetica','20','bold',), fill='#800000')
    text4 = canvas1.create_text(520,50,text=currCards, font=('Helvetica','20','bold'), fill='#800000')
    textResult = canvas1.create_text(520,150,text=resulttxt, font=('Helvetica','25','bold'))
    ...
    while 1:
        ...
        if received == "2":
            ...
            if spliced[0] == "p":
                ...
                canvas1.itemconfigure(text3, text=currTotal)
                canvas1.itemconfigure(text4, text=currCards)
            elif spliced[0] == "pl":
                ...
                canvas1.itemconfigure(text1, text=dealTotal)
                canvas1.itemconfigure(text2, text=dealCards)
    clientSocket.close()
