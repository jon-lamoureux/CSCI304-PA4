...
def createGUI():
    ...
    text1 = canvas1.create_text(520,440,text=dealTotal, font=('Helvetica','20','bold'))
    text2 = canvas1.create_text(520 ,380,text=dealCards, font=('Helvetica','20','bold'))
    text3 = canvas1.create_text(520,50,text=currTotal, font=('Helvetica','20','bold',), fill='red')
    text4 = canvas1.create_text(520,110,text=currCards, font=('Helvetica','20','bold'), fill='red')
